package com.nqt.message_service.exception;
...
public enum ErrorCode {
    ...
    NOTIFICATION_NOT_FOUND(5006, HttpStatus.NOT_FOUND, "Message not found"),
    CHAT_ROOM_NOT_FOUND(5007, HttpStatus.NOT_FOUND, "Chat room not found"),
    ;
